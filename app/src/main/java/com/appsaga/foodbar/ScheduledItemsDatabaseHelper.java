...
public class ScheduledItemsDatabaseHelper extends SQLiteOpenHelper {

    public static final String DATABASE_NAME=" scheduled_items.db";
    public static final String TABLE_NAME=" ScheduledItemsTable";
    ...
    public ScheduledItemsDatabaseHelper(Context context){
