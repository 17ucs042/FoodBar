...
public class SavedAddressAdapter extends CursorAdapter {

    public SavedAddressAdapter(Context context, Cursor cursor) {
    ...
    public View newView(Context context, Cursor cursor, ViewGroup parent) {
        ...
        View v = LayoutInflater.from(context).inflate(R.layout.save_address_view, parent, false);
        return v;
    }
    ...
    public void bindView(final View view, final Context context, final Cursor cursor)
    {
        ...
        radioButton.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                Intent intent = new Intent(context,SelectDeliveryInterval.class);
                Address address2 = new Address(name.getText().toString(),phone.getText().toString(), finalHouseNo,cursor.getString(cursor.getColumnIndex("area")),
                        cursor.getString(cursor.getColumnIndex("pincode")),cursor.getString(cursor.getColumnIndex("nickname")));
